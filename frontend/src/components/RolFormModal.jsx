      ...
      <div className="bg-white p-6 rounded shadow-md w-full max-w-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex justify-end gap-2">
            <button type="button" onClick={cerrar} className="px-4 py-2 border rounded bg-red-500 hover:bg-red-600 text-white">Cancelar</button>
            <button type="submit" className="px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded">{esEdicion ? "Actualizar" : "Crear"}</button>
          </div>
        </form>
      </div>
    </div>
